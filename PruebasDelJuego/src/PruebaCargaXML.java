...
/**
 * 
 * ***Atención:*** Todavía NO está terminada. La idea es que no
 * setee NINGÚN dato de los objetos (éstos se obtendrán del XML),
 * solo tengo que cargar controladores de la vista.-
 * 
 * */
public class PruebaCargaXML {
	...
	public static void main(String[] args) {
		...
		nivel.cargarJuego("PruebaSiete.xml"); //<<<<<<<<< Acá va el nombre de lo que quiero cargar.-
